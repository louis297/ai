...
from argparse import ArgumentParser  # Command line parsing
...
class Chatbot:
    ...
    def parseArgs(args):
        ...
        globalArgs.add_argument('--test',
                                ...
                                const=Chatbot.TestMode.ALL, default='interactive',
        ...
        globalArgs.add_argument('--modelTag', type=str, default='demo1', help='tag to differentiate which model to store/load')
        ...
        #globalArgs.add_argument('runserver', action='store_true', help='')

        # Dataset options
        datasetArgs = parser.add_argument_group('Dataset options')
        datasetArgs.add_argument('--corpus', choices=TextData.corpusChoices(), default=TextData.corpusChoices()[4], help='corpus on which extract the dataset.')
    ...
    def main(self, args=None):
        ...
        # Prepare the model
        if type(self.getDevice()) != list:
            with tf.device(self.getDevice()):
                self.model = Model(self.args, self.textData)
        else:
            for device in self.getDevice():
    ...
    def getDevice(self):
        ...
        if self.args.device == 'cpu':
            return ['/cpu:0', '/cpu:1', '/cpu:2', '/cpu:3', '/cpu:4', '/cpu:5', '/cpu:6', '/cpu:7']
        elif self.args.device == 'gpu':
            return '/gpu:0'
        elif self.args.device == 'g0':
            return '/gpu:0'
        elif self.args.device == 'g1':
            return '/gpu:1'
        elif self.args.device == 'g2':
            return '/gpu:2'
        elif self.args.device == 'g3':
            return '/gpu:3'
